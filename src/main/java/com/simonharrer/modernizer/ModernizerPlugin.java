...
public class ModernizerPlugin implements Plugin<Project> {
  ...
  public void apply(Project project) {
    final ModernizerPluginExtension extension =
        project.getExtensions().create(MODERNIZER, ModernizerPluginExtension.class);
    final ModernizerTask modernizerTask =
        project.getTasks().create(MODERNIZER, ModernizerTask.class);
    modernizerTask.setGroup("Verification");
    modernizerTask.setDescription(
